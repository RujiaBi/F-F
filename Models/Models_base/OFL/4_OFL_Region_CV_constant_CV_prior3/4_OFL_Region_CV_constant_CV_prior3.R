...
# Run jags model
system.time(fit <- run.jags(model="4_OFL_Region_CV_constant_CV_prior3.txt", monitor=params, data=data, burnin=10000, sample=1000, adapt=10000, thin=20, n.chains=5, method = 'rjparallel'))
save(fit, file = '4_OFL_Region_CV_constant_CV_prior3_fit.RData')
fit0 = add.summary(fit)
save(fit0, file = '4_OFL_Region_CV_constant_CV_prior3_fit0.RData')
dic=extract(fit, 'dic')
save(dic, file='4_OFL_Region_CV_constant_CV_prior3_dic.RData')

load('4_OFL_Region_CV_constant_CV_prior3_dic.RData')
load('4_OFL_Region_CV_constant_CV_prior3_fit.RData')
