...
# Run jags model
system.time(fit <- run.jags(model="4_F_Fmsy_Region_CV_constant.txt", monitor=params, data=data, burnin=20000, sample=1000, adapt=20000, thin=20, n.chains=5, method = 'rjparallel'))
save(fit, file = '4_F_Fmsy_Region_CV_constant_fit.RData')
fit0 = add.summary(fit)
save(fit0, file = '4_F_Fmsy_Region_CV_constant_fit0.RData')
dic=extract(fit, 'dic')
save(dic, file='4_F_Fmsy_Region_CV_constant_dic.RData')

load('4_F_Fmsy_Region_CV_constant_dic.RData')
load('4_F_Fmsy_Region_CV_constant_fit.RData')
