...
# Run jags model
system.time(fit <- run.jags(model="1_OFL_Common_CV_mu.txt", monitor=params, data=data, burnin=10000, sample=1000, adapt=10000, thin=20, n.chains=5, method = 'rjparallel'))
save(fit, file = '1_OFL_Common_CV_mu_fit.RData')
dic=extract(fit, 'dic')
save(dic, file='1_OFL_Common_CV_mu_dic.RData')
