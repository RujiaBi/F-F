...
# Run jags model
system.time(fit <- run.jags(model="4_B_Bmsy_Region_CV_constant_mu.txt", monitor=params, data=data, burnin=20000, sample=1000, adapt=20000, thin=20, n.chains=5, method = 'rjparallel'))
save(fit, file = '4_B_Bmsy_Region_CV_constant_mu_fit.RData')
dic=extract(fit, 'dic')
save(dic, file='4_B_Bmsy_Region_CV_constant_mu_dic.RData')

load('4_B_Bmsy_Region_CV_constant_mu_dic.RData')
load('4_B_Bmsy_Region_CV_constant_mu_fit.RData')
